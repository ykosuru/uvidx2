...
def cmd_index(args):
    ...
    # Create pipeline with specified embedder (default: hash - no external APIs needed)
    pipeline = IndexingPipeline(vocabulary_path=args.vocabulary, embedder_type=args.embedder)
...
def main():
    ...
    index_parser.add_argument('--embedder', choices=['hash', 'tfidf', 'bm25', 'domain'], default='hash',
