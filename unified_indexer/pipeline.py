...
class IndexingPipeline:
    ...
    def index_file(self, file_path: str, domain: str = "default") -> IndexingResult:
        """
        Index a single file
        
        Args:
            file_path: Path to the file
            domain: Domain tag for logical separation
    ...
    def index_directory(self, 
        ...
        Args:
            ...
            domain: Domain tag for all files in this directory
        ...
        if max_workers > 1:
            ...
            with ThreadPoolExecutor(max_workers=max_workers) as executor:
                futures = {
                    executor.submit(self.index_file, fp, domain): fp 
            ...
            for i, file_path in enumerate(files_to_process):
                ...
                result = self.index_file(file_path, domain)
                self._update_stats(stats, result)
    ...
    def index_content(self, 
                      ...
                      domain: str = "default") -> List[IndexableChunk]:
        """
    ...
    def search(self, 
        ...
        """
        # Get more results if filtering by domain
        fetch_k = top_k * 3 if domains else top_k
    ...
    def get_domains(self) -> Dict[str, int]:
        """
        Get available domains and chunk counts.
